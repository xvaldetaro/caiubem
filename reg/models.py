...
class Address(TimeStampedModel):
	...
	address_line1 = models.CharField(max_length=100, verbose_name=u'Endereço linha 1')
	address_line2 = models.CharField(max_length=100, blank=True,
				verbose_name=u'Endereço linha 2')
...
class CandidateSuggestion(TimeStampedModel):
	candidate = models.ForeignKey(Candidate)
	suggestion = models.TextField(verbose_name=u'Sugestões',blank=True)
